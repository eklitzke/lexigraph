...
def is_undefined(obj):
    ...
    this::
        ...
        def default(var, default=''):
            ...
            return var
    """
    from vendor.jinja2.runtime import Undefined
...
def clear_caches():
    ...
    """
    from vendor.jinja2.environment import _spontaneous_environments
    from vendor.jinja2.lexer import _lexer_cache
...
def generate_lorem_ipsum(n=5, html=True, min=20, max=100):
    ...
    from vendor.jinja2.constants import LOREM_IPSUM_WORDS
...
class Markup(unicode):
    ...
    def unescape(self):
        ...
        """
        from vendor.jinja2.constants import HTML_ENTITIES
        def handle_match(m):
            name = m.group(1)
...
try:
    from vendor.jinja2._speedups import escape, soft_unicode
except ImportError:
    def escape(s):

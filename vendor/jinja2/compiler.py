...
from vendor.jinja2.visitor import NodeVisitor, NodeTransformer
from vendor.jinja2.exceptions import TemplateAssertionError
from vendor.jinja2.utils import Markup, concat, escape, is_python_keyword, next
...
class CodeGenerator(NodeVisitor):
    ...
    def visit_Template(self, node, frame=None):
        ...
        from vendor.jinja2.runtime import __all__ as exported
        self.writeline('from __future__ import division')
        self.writeline('from vendor.jinja2.runtime import ' + ', '.join(exported))

...
import sys
import traceback
from vendor.jinja2.utils import CodeType, missing, internal_code
...
class ProcessedTraceback(object):
    ...
    def render_as_html(self, full=False):
        ...
        from vendor.jinja2.debugrenderer import render_traceback
        return u'%s\n\n<!--\n%s\n-->' % (
...
try:
    from vendor.jinja2._speedups import tb_set_next
except ImportError:
    try:

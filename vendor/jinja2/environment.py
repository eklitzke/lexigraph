...
from vendor.jinja2.defaults import *
from vendor.jinja2.lexer import get_lexer, TokenStream
from vendor.jinja2.parser import Parser
from vendor.jinja2.optimizer import optimize
from vendor.jinja2.compiler import generate
from vendor.jinja2.runtime import Undefined, new_context
from vendor.jinja2.exceptions import TemplateSyntaxError
from vendor.jinja2.utils import import_string, LRUCache, Markup, missing, \
...
class Environment(object):
    ...
    def handle_exception(self, exc_info=None, rendered=False, source_hint=None):
        ...
        if _make_traceback is None:
            from vendor.jinja2.debug import make_traceback as _make_traceback
